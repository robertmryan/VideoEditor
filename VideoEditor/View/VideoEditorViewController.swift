...
@objc class VideoEditorViewController: UIViewController {
    ...
    func setCanvasUI() {
        ...
        undoButton.configure(with: CanvasModelButtonModel(
        ...
        colorPicker.configure(with: CanvasModelButtonModel(
        ...
        trashCanButton.configure(with: CanvasModelButtonModel(
        ...
        uploadViewButton.configure(with: CanvasModelButtonModel(
        ...
        test.configure(with: CanvasModelButtonModel(
            image: UIImage(systemName: "pencil.circle")?
                .withTintColor(.white, renderingMode: .alwaysOriginal), 
            width: 51,
            height: 48,
